...
const NEIGHBORHOODS = [
  ...
  // --- Caribbean ---
  { id: 'nassau',      name: 'Cable Beach',     city: 'Nassau',            center: { lat: 25.0780, lng: -77.3400 }, radius: 480, bestFor: ['Dancing', 'Beach'] },
  { id: 'kingston-jm', name: 'New Kingston',    city: 'Kingston',          center: { lat: 18.0080, lng: -76.7830 }, radius: 480, bestFor: ['Dancing', 'Live'] },
  { id: 'montegobay',  name: 'Hip Strip',       city: 'Montego Bay',       center: { lat: 18.4900, lng: -77.9200 }, radius: 460, bestFor: ['Beach', 'Dancing'] },
  { id: 'hamilton-bm', name: 'Hamilton',        city: 'Hamilton',          center: { lat: 32.2949, lng: -64.7860 }, radius: 440, bestFor: ['Bars', 'Dancing'] },
  { id: 'santodomingo',name: 'Zona Colonial',   city: 'Santo Domingo',     center: { lat: 18.4730, lng: -69.8840 }, radius: 480, bestFor: ['Dancing', 'Bars'] },
  { id: 'puntacana',   name: 'Punta Cana',      city: 'Punta Cana',        center: { lat: 18.5820, lng: -68.4050 }, radius: 520, bestFor: ['Dancing', 'Beach'] },
  // --- USA / Pacific ---
  { id: 'sandiego',    name: 'Gaslamp Quarter', city: 'San Diego',         center: { lat: 32.7115, lng: -117.1600 }, radius: 480, bestFor: ['Dancing', 'Bars'] },
  { id: 'honolulu',    name: 'Waikiki',         city: 'Honolulu',          center: { lat: 21.2790, lng: -157.8290 }, radius: 480, bestFor: ['Beach', 'Dancing'] },
  { id: 'portland-or', name: 'Portland',        city: 'Portland',          center: { lat: 45.5230, lng: -122.6760 }, radius: 480, bestFor: ['Bars', 'Dancing'] },
  // --- more blank areas: Asia ---
  { id: 'phnompenh',   name: 'Phnom Penh',      city: 'Phnom Penh',        center: { lat: 11.5564, lng: 104.9282 }, radius: 480, bestFor: ['Dancing', 'Bars'] },
  { id: 'colombo',     name: 'Colombo',         city: 'Colombo',           center: { lat: 6.9271,  lng: 79.8612 },  radius: 480, bestFor: ['Dancing', 'Bars'] },
  { id: 'cebu',        name: 'Cebu',            city: 'Cebu',              center: { lat: 10.3157, lng: 123.8854 }, radius: 480, bestFor: ['Dancing', 'Bars'] },
  { id: 'hyderabad',   name: 'Jubilee Hills',   city: 'Hyderabad',         center: { lat: 17.4300, lng: 78.4070 }, radius: 500, bestFor: ['Dancing', 'Bars'] },
  { id: 'pune',        name: 'Koregaon Park',   city: 'Pune',              center: { lat: 18.5360, lng: 73.8940 }, radius: 480, bestFor: ['Dancing', 'Bars'] },
  // --- major missing US cities ---
  { id: 'seattle',     name: 'Capitol Hill',    city: 'Seattle',           center: { lat: 47.6150, lng: -122.3200 }, radius: 480, bestFor: ['Dancing', 'Bars'] },
  { id: 'boston',      name: 'Theater District', city: 'Boston',           center: { lat: 42.3510, lng: -71.0640 }, radius: 480, bestFor: ['Dancing', 'Bars'] },
  { id: 'philadelphia',name: 'Center City',     city: 'Philadelphia',      center: { lat: 39.9490, lng: -75.1600 }, radius: 480, bestFor: ['Dancing', 'Bars'] },
  { id: 'charlotte',   name: 'Uptown',          city: 'Charlotte',         center: { lat: 35.2270, lng: -80.8430 }, radius: 460, bestFor: ['Bars', 'Dancing'] },
  { id: 'tampa',       name: 'Ybor City',       city: 'Tampa',             center: { lat: 27.9600, lng: -82.4370 }, radius: 460, bestFor: ['Dancing', 'Bars'] },
  { id: 'orlando',     name: 'Downtown',        city: 'Orlando',           center: { lat: 28.5420, lng: -81.3760 }, radius: 460, bestFor: ['Dancing', 'Bars'] },
  { id: 'pittsburgh',  name: 'Strip District',  city: 'Pittsburgh',        center: { lat: 40.4500, lng: -79.9760 }, radius: 460, bestFor: ['Bars', 'Dancing'] },
  { id: 'cleveland',   name: 'East 4th',        city: 'Cleveland',         center: { lat: 41.4990, lng: -81.6900 }, radius: 460, bestFor: ['Bars', 'Live'] },
  { id: 'sacramento',  name: 'Midtown',         city: 'Sacramento',        center: { lat: 38.5700, lng: -121.4780 }, radius: 460, bestFor: ['Bars', 'Dancing'] },
  { id: 'sanjose',     name: 'SoFA',            city: 'San Jose',          center: { lat: 37.3300, lng: -121.8860 }, radius: 460, bestFor: ['Bars', 'Dancing'] },
  // --- Europe gaps ---
  { id: 'naples',      name: 'Chiaia',          city: 'Naples',            center: { lat: 40.8330, lng: 14.2360 }, radius: 460, bestFor: ['Bars', 'Dancing'] },
  { id: 'florence',    name: 'Florence',        city: 'Florence',          center: { lat: 43.7710, lng: 11.2540 }, radius: 460, bestFor: ['Bars', 'Dancing'] },
  { id: 'malaga',      name: 'Centro',          city: 'Malaga',            center: { lat: 36.7210, lng: -4.4210 }, radius: 460, bestFor: ['Bars', 'Dancing'] },
  { id: 'bordeaux',    name: 'Bordeaux',        city: 'Bordeaux',          center: { lat: 44.8410, lng: -0.5760 }, radius: 460, bestFor: ['Bars', 'Dancing'] },
  { id: 'stuttgart',   name: 'Stuttgart',       city: 'Stuttgart',         center: { lat: 48.7740, lng: 9.1790 },  radius: 460, bestFor: ['Dancing', 'Bars'] },
  { id: 'gdansk',      name: 'Gdańsk',          city: 'Gdańsk',            center: { lat: 54.3480, lng: 18.6530 }, radius: 460, bestFor: ['Bars', 'Dancing'] },
  { id: 'split',       name: 'Bačvice',         city: 'Split',             center: { lat: 43.5060, lng: 16.4500 }, radius: 460, bestFor: ['Beach', 'Dancing'] },
  { id: 'gothenburg',  name: 'Avenyn',          city: 'Gothenburg',        center: { lat: 57.7000, lng: 11.9740 }, radius: 460, bestFor: ['Bars', 'Dancing'] },
  // --- Asia gaps ---
  { id: 'chennai',     name: 'Chennai',         city: 'Chennai',           center: { lat: 13.0600, lng: 80.2500 }, radius: 480, bestFor: ['Dancing', 'Bars'] },
  { id: 'danang',      name: 'Da Nang',         city: 'Da Nang',           center: { lat: 16.0600, lng: 108.2300 }, radius: 480, bestFor: ['Dancing', 'Beach'] },
  { id: 'chiangmai',   name: 'Nimman',          city: 'Chiang Mai',        center: { lat: 18.7960, lng: 98.9670 }, radius: 460, bestFor: ['Bars', 'Dancing'] },
  { id: 'busan',       name: 'Seomyeon',        city: 'Busan',             center: { lat: 35.1580, lng: 129.0590 }, radius: 480, bestFor: ['Dancing', 'Bars'] },
  { id: 'fukuoka',     name: 'Nakasu',          city: 'Fukuoka',           center: { lat: 33.5920, lng: 130.4040 }, radius: 460, bestFor: ['Dancing', 'Bars'] },
  { id: 'kolkata',     name: 'Park Street',     city: 'Kolkata',           center: { lat: 22.5520, lng: 88.3520 }, radius: 480, bestFor: ['Bars', 'Dancing'] },
];
...
const VENUE_DEFS = [
  ...
  // --- discovered from Google Places ---
  ['High Society Club Cebu', 'cebu', 'Dancing', 'Club', 400, 0, 9, 10, { mult: 1, trend: 0.6 }, true],
  ['TIPSY SUPER CLUB CEBU', 'cebu', 'Dancing', 'Club', 400, 0, 11, 10, { mult: 1, trend: 0.6 }, true],
  ['Trademark Bar, Best Hip-Hop Club, Cebu', 'cebu', 'Dancing', 'Club', 400, 0, 11, 10, { mult: 1, trend: 0.6 }, true],
  ['Nocturnal Sebu Superclub', 'cebu', 'Dancing', 'Club', 400, 0, 11, 10, { mult: 1, trend: 0.6 }, true],
  ['CEBU ICON', 'cebu', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['The Love Bar at Flamingo House', 'colombo', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['The Chiller Room', 'colombo', 'Dancing', 'Club', 400, 0, 13, 30, { mult: 1, trend: 0.6 }, true],
  ['Cleopatra Nightclub', 'colombo', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['W Lounge', 'colombo', 'Dancing', 'Club', 400, 0, 11, 10, { mult: 1, trend: 0.6 }, true],
  ['Rhythm and Blues (R&B)', 'colombo', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['Casey’s Lounge', 'hamilton-bm', 'Dancing', 'Club', 400, 0, 8, 10, { mult: 1, trend: 0.6 }, true],
  ['Bungalow56', 'hamilton-bm', 'Dancing', 'Club', 400, 0, 8, 10, { mult: 1, trend: 0.6 }, true],
  ['The Front Yard', 'hamilton-bm', 'Bars', 'Bar', 180, 0, 10, 18, { mult: 1, trend: 0.6 }, true],
  ['Docksider', 'hamilton-bm', 'Bars', 'Bar', 180, 0, 11, 18, { mult: 1, trend: 0.6 }, true],
  ['Outback Sport Bar', 'hamilton-bm', 'Bars', 'Bar', 180, 0, 10, 0, { mult: 1, trend: 0.6 }, true],
  ['Velvet Nightclub', 'honolulu', 'Dancing', 'Club', 400, 0, 11, 10, { mult: 1, trend: 0.6 }, true],
  ['Ballarrinas Gentlemen\'s Club 18+', 'honolulu', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['The District', 'honolulu', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['Haus of Dyms Gentlemen\'s Lounge', 'honolulu', 'Dancing', 'Club', 400, 0, 9, 30, { mult: 1, trend: 0.6 }, true],
  ['Hawaii By Night Gentlemen\'s Club', 'honolulu', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['Carpe Diem', 'hyderabad', 'Dancing', 'Club', 400, 0, 18, 30, { mult: 1, trend: 0.6 }, true],
  ['ILLUZION CLUB & KITCHEN', 'hyderabad', 'Dancing', 'Club', 400, 0, 14, 30, { mult: 1, trend: 0.6 }, true],
  ['Club N', 'hyderabad', 'Dancing', 'Club', 400, 0, 16, 30, { mult: 1, trend: 0.6 }, true],
  ['Club Rogue Gachibowli', 'hyderabad', 'Dancing', 'Club', 400, 0, 20, 30, { mult: 1, trend: 0.6 }, true],
  ['Prism Club & Kitchen', 'hyderabad', 'Dancing', 'Club', 400, 0, 18, 30, { mult: 1, trend: 0.6 }, true],
  ['Taboo Kingston', 'kingston-jm', 'Dancing', 'Club', 400, 0, 11, 10, { mult: 1, trend: 0.6 }, true],
  ['Marketplace Entertainment Centre For The Arts - MECA', 'kingston-jm', 'Dancing', 'Club', 400, 0, 10, 10, { mult: 1, trend: 0.6 }, true],
  ['Uptown Mondays', 'kingston-jm', 'Dancing', 'Club', 400, 0, 10, 5, { mult: 1, trend: 0.6 }, true],
  ['Kingston Dub Club', 'kingston-jm', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['420 hookah lounge', 'kingston-jm', 'Dancing', 'Club', 400, 0, 12, 10, { mult: 1, trend: 0.6 }, true],
  ['Taboo Montego Bay', 'montegobay', 'Dancing', 'Club', 400, 0, 10, 10, { mult: 1, trend: 0.6 }, true],
  ['Pure Ultra Lounge', 'montegobay', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['Lounge 2727', 'montegobay', 'Dancing', 'Club', 400, 0, 14, 5, { mult: 1, trend: 0.6 }, true],
  ['Blue Beat Ultra Lounge', 'montegobay', 'Dancing', 'Club', 400, 0, 9, 10, { mult: 1, trend: 0.6 }, true],
  ['Lounge Zero', 'montegobay', 'Dancing', 'Club', 400, 0, 9, 10, { mult: 1, trend: 0.6 }, true],
  ['Bond Nightclub at SLS Baha Mar', 'nassau', 'Dancing', 'Club', 400, 0, 8, 10, { mult: 1, trend: 0.6 }, true],
  ['Waterloo', 'nassau', 'Dancing', 'Club', 400, 0, 8, 10, { mult: 1, trend: 0.6 }, true],
  ['Aura Nightclub', 'nassau', 'Dancing', 'Club', 400, 0, 11, 10, { mult: 1, trend: 0.6 }, true],
  ['Sunset Beach Club', 'nassau', 'Dancing', 'Club', 400, 0, 12, 10, { mult: 1, trend: 0.6 }, true],
  ['Cheetahs Lounge', 'nassau', 'Dancing', 'Club', 400, 0, 8, 10, { mult: 1, trend: 0.6 }, true],
  ['Central X Club', 'phnompenh', 'Dancing', 'Club', 400, 0, 9, 30, { mult: 1, trend: 0.6 }, true],
  ['LOVE - Phnom Penh', 'phnompenh', 'Dancing', 'Club', 400, 0, 16, 10, { mult: 1, trend: 0.6 }, true],
  ['H Club', 'phnompenh', 'Dancing', 'Club', 400, 0, 11, 10, { mult: 1, trend: 0.6 }, true],
  ['EDM9 club', 'phnompenh', 'Dancing', 'Club', 400, 0, 11, 30, { mult: 1, trend: 0.6 }, true],
  ['ULTRA CLUB CAMBODIA', 'phnompenh', 'Dancing', 'Club', 400, 0, 9, 30, { mult: 1, trend: 0.6 }, true],
  ['Kasa Nightclub Portland', 'portland-or', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['Calle 6 Night Club', 'portland-or', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['Elevate Nightclub', 'portland-or', 'Dancing', 'Club', 400, 0, 10, 5, { mult: 1, trend: 0.6 }, true],
  ['District Nightclub', 'portland-or', 'Dancing', 'Club', 400, 0, 15, 10, { mult: 1, trend: 0.6 }, true],
  ['45 East', 'portland-or', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['L7 Club & Lounge', 'pune', 'Dancing', 'Club', 400, 0, 17, 10, { mult: 1, trend: 0.6 }, true],
  ['Elrow pune', 'pune', 'Dancing', 'Club', 400, 0, 16, 30, { mult: 1, trend: 0.6 }, true],
  ['Penthouze Nightlife', 'pune', 'Dancing', 'Club', 400, 0, 15, 30, { mult: 1, trend: 0.6 }, true],
  ['Plunge', 'pune', 'Dancing', 'Club', 400, 0, 17, 10, { mult: 1, trend: 0.6 }, true],
  ['Vegas The Night Club', 'pune', 'Dancing', 'Club', 400, 0, 9, 10, { mult: 1, trend: 0.6 }, true],
  ['Imagine Punta Cana', 'puntacana', 'Dancing', 'Club', 400, 0, 16, 5, { mult: 1, trend: 0.6 }, true],
  ['Coco Bongo Punta Cana', 'puntacana', 'Dancing', 'Club', 400, 0, 19, 5, { mult: 1, trend: 0.6 }, true],
  ['El Kan Drink House', 'puntacana', 'Dancing', 'Club', 400, 0, 16, 10, { mult: 1, trend: 0.6 }, true],
  ['Maroca Club', 'puntacana', 'Dancing', 'Club', 400, 0, 12, 10, { mult: 1, trend: 0.6 }, true],
  ['Oro Nightclub', 'puntacana', 'Dancing', 'Club', 400, 0, 13, 5, { mult: 1, trend: 0.6 }, true],
  ['Onyx Room', 'sandiego', 'Dancing', 'Club', 400, 0, 14, 30, { mult: 1, trend: 0.6 }, true],
  ['Spin Nightclub', 'sandiego', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['Altitude Sky Lounge', 'sandiego', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['SideBar Nightclub San Diego', 'sandiego', 'Dancing', 'Club', 400, 0, 14, 30, { mult: 1, trend: 0.6 }, true],
  ['Sevilla Nightclub of San Diego', 'sandiego', 'Dancing', 'Club', 400, 0, 11, 5, { mult: 1, trend: 0.6 }, true],
  ['VIP ROOM Santo Domingo', 'santodomingo', 'Dancing', 'Club', 400, 0, 11, 30, { mult: 1, trend: 0.6 }, true],
  ['The World', 'santodomingo', 'Dancing', 'Club', 400, 0, 12, 30, { mult: 1, trend: 0.6 }, true],
  ['Gold Fashion Dance Club', 'santodomingo', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['Parada 77', 'santodomingo', 'Dancing', 'Club', 400, 0, 17, 10, { mult: 1, trend: 0.6 }, true],
  ['Templo Lounge', 'santodomingo', 'Dancing', 'Club', 400, 0, 12, 10, { mult: 1, trend: 0.6 }, true],
  // --- discovered from Google Places ---
  ['Le Cercle - Boite de nuit à Bordeaux', 'bordeaux', 'Dancing', 'Club', 400, 0, 16, 10, { mult: 1, trend: 0.6 }, true],
  ['Red Kiss - Club de strip tease à Bordeaux', 'bordeaux', 'Dancing', 'Club', 400, 0, 9, 30, { mult: 1, trend: 0.6 }, true],
  ['Black Diamond - Bordeaux', 'bordeaux', 'Dancing', 'Club', 400, 0, 11, 30, { mult: 1, trend: 0.6 }, true],
  ['Le Theatro', 'bordeaux', 'Dancing', 'Club', 400, 0, 16, 10, { mult: 1, trend: 0.6 }, true],
  ['Pachanga Club Bordeaux', 'bordeaux', 'Dancing', 'Club', 400, 0, 10, 10, { mult: 1, trend: 0.6 }, true],
  ['Venu Nightclub', 'boston', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['Icon Nightclub', 'boston', 'Dancing', 'Club', 400, 0, 12, 10, { mult: 1, trend: 0.6 }, true],
  ['The Grand Boston', 'boston', 'Dancing', 'Club', 400, 0, 15, 10, { mult: 1, trend: 0.6 }, true],
  ['51 Nightclub', 'boston', 'Dancing', 'Club', 400, 0, 8, 10, { mult: 1, trend: 0.6 }, true],
  ['Royale', 'boston', 'Dancing', 'Club', 400, 0, 15, 10, { mult: 1, trend: 0.6 }, true],
  ['CLUB NASUB', 'busan', 'Dancing', 'Club', 400, 0, 8, 10, { mult: 1, trend: 0.6 }, true],
  ['groove club busan', 'busan', 'Dancing', 'Club', 400, 0, 13, 5, { mult: 1, trend: 0.6 }, true],
  ['PartyNextDoor(Busan Club)', 'busan', 'Dancing', 'Club', 400, 0, 11, 10, { mult: 1, trend: 0.6 }, true],
  ['제제 라운지 JEJE LOUNGE', 'busan', 'Dancing', 'Club', 400, 0, 11, 5, { mult: 1, trend: 0.6 }, true],
  ['Thursday Party, Seomyeon', 'busan', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['Encore Nightclub Charlotte', 'charlotte', 'Dancing', 'Club', 400, 0, 11, 30, { mult: 1, trend: 0.6 }, true],
  ['Club Onyx', 'charlotte', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['The Hive', 'charlotte', 'Dancing', 'Club', 400, 0, 11, 10, { mult: 1, trend: 0.6 }, true],
  ['Trio Charlotte', 'charlotte', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['Tequila House Nightclub', 'charlotte', 'Dancing', 'Club', 400, 0, 12, 5, { mult: 1, trend: 0.6 }, true],
  ['Lower Deck Bar & Nightclub', 'chennai', 'Dancing', 'Club', 400, 0, 16, 30, { mult: 1, trend: 0.6 }, true],
  ['Pasha', 'chennai', 'Dancing', 'Club', 400, 0, 17, 30, { mult: 1, trend: 0.6 }, true],
  ['Flame Le Club', 'chennai', 'Dancing', 'Club', 400, 0, 13, 30, { mult: 1, trend: 0.6 }, true],
  ['Vibe Restobar', 'chennai', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['The Leather Bar', 'chennai', 'Dancing', 'Club', 400, 0, 16, 30, { mult: 1, trend: 0.6 }, true],
  ['BlackLight CNX', 'chiangmai', 'Dancing', 'Club', 400, 0, 16, 5, { mult: 1, trend: 0.6 }, true],
  ['Zoe in Yellow', 'chiangmai', 'Dancing', 'Club', 400, 0, 18, 10, { mult: 1, trend: 0.6 }, true],
  ['Differ Inc Chiang Mai', 'chiangmai', 'Dancing', 'Club', 400, 0, 12, 10, { mult: 1, trend: 0.6 }, true],
  ['Hollywood Gentlemen\'s club', 'chiangmai', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['CREAM Club', 'chiangmai', 'Dancing', 'Club', 400, 0, 11, 10, { mult: 1, trend: 0.6 }, true],
  ['Decades Cleveland', 'cleveland', 'Dancing', 'Club', 400, 0, 12, 5, { mult: 1, trend: 0.6 }, true],
  ['FWD Day + Nightclub', 'cleveland', 'Dancing', 'Club', 400, 0, 12, 30, { mult: 1, trend: 0.6 }, true],
  ['Lost Social Club', 'cleveland', 'Dancing', 'Club', 400, 0, 10, 10, { mult: 1, trend: 0.6 }, true],
  ['Rumor Bar & Lounge', 'cleveland', 'Dancing', 'Club', 400, 0, 11, 5, { mult: 1, trend: 0.6 }, true],
  ['Bird of Paradise under Bright Side Restaurant', 'cleveland', 'Dancing', 'Club', 400, 0, 8, 10, { mult: 1, trend: 0.6 }, true],
  ['For You Club', 'danang', 'Dancing', 'Club', 400, 0, 16, 30, { mult: 1, trend: 0.6 }, true],
  ['Koto Club', 'danang', 'Dancing', 'Club', 400, 0, 15, 10, { mult: 1, trend: 0.6 }, true],
  ['New Phương Đông', 'danang', 'Dancing', 'Club', 400, 0, 17, 10, { mult: 1, trend: 0.6 }, true],
  ['ADM CLUB', 'danang', 'Dancing', 'Club', 400, 0, 17, 30, { mult: 1, trend: 0.6 }, true],
  ['Bloom Night Club', 'danang', 'Dancing', 'Club', 400, 0, 16, 10, { mult: 1, trend: 0.6 }, true],
  ['YAB | Discoteca Firenze', 'florence', 'Dancing', 'Club', 400, 0, 15, 10, { mult: 1, trend: 0.6 }, true],
  ['Chez Moi Night Club', 'florence', 'Dancing', 'Club', 400, 0, 9, 10, { mult: 1, trend: 0.6 }, true],
  ['XO CLUB & LOUNGE - DISCOTECA IN CENTRO A FIRENZE', 'florence', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['Pink Street Club', 'florence', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['Tenax Discoteca Club Firenze', 'florence', 'Dancing', 'Club', 400, 0, 16, 10, { mult: 1, trend: 0.6 }, true],
  ['Ibiza', 'fukuoka', 'Dancing', 'Club', 400, 0, 16, 10, { mult: 1, trend: 0.6 }, true],
  ['BLACK BAMBI', 'fukuoka', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['Cat\'s', 'fukuoka', 'Dancing', 'Club', 400, 0, 15, 10, { mult: 1, trend: 0.6 }, true],
  ['Happy Cock', 'fukuoka', 'Dancing', 'Club', 400, 0, 12, 10, { mult: 1, trend: 0.6 }, true],
  ['Night Club Gekko NAKASU', 'fukuoka', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['Chmielna 101 Cooltura', 'gdansk', 'Dancing', 'Club', 400, 0, 16, 10, { mult: 1, trend: 0.6 }, true],
  ['Broadway Show', 'gdansk', 'Dancing', 'Club', 400, 0, 13, 30, { mult: 1, trend: 0.6 }, true],
  ['Tkacka Music Club', 'gdansk', 'Dancing', 'Club', 400, 0, 15, 10, { mult: 1, trend: 0.6 }, true],
  ['Bunkier Music Club', 'gdansk', 'Dancing', 'Club', 400, 0, 17, 10, { mult: 1, trend: 0.6 }, true],
  ['Rozii Night Club Gdańsk', 'gdansk', 'Dancing', 'Club', 400, 0, 11, 10, { mult: 1, trend: 0.6 }, true],
  ['Park Lane', 'gothenburg', 'Dancing', 'Club', 400, 0, 15, 30, { mult: 1, trend: 0.6 }, true],
  ['Lounge(s)', 'gothenburg', 'Dancing', 'Club', 400, 0, 12, 10, { mult: 1, trend: 0.6 }, true],
  ['Yaki-Da', 'gothenburg', 'Dancing', 'Club', 400, 0, 16, 10, { mult: 1, trend: 0.6 }, true],
  ['Valand', 'gothenburg', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['The Melody Club', 'gothenburg', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['The Myx, Kolkata, Park Street Area', 'kolkata', 'Dancing', 'Club', 400, 0, 15, 10, { mult: 1, trend: 0.6 }, true],
  ['Roxy', 'kolkata', 'Dancing', 'Club', 400, 0, 18, 30, { mult: 1, trend: 0.6 }, true],
  ['Makati Kolkata', 'kolkata', 'Dancing', 'Club', 400, 0, 15, 30, { mult: 1, trend: 0.6 }, true],
  ['La Dolce Vita', 'kolkata', 'Dancing', 'Club', 400, 0, 15, 10, { mult: 1, trend: 0.6 }, true],
  ['Drunken Teddy', 'kolkata', 'Dancing', 'Club', 400, 0, 15, 10, { mult: 1, trend: 0.6 }, true],
  ['Barsovia Club', 'malaga', 'Dancing', 'Club', 400, 0, 20, 10, { mult: 1, trend: 0.6 }, true],
  ['EUPHORIA CLUB', 'malaga', 'Dancing', 'Club', 400, 0, 12, 10, { mult: 1, trend: 0.6 }, true],
  ['Tennessee Live Club Málaga', 'malaga', 'Dancing', 'Club', 400, 0, 17, 10, { mult: 1, trend: 0.6 }, true],
  ['Mirror Night Club', 'malaga', 'Dancing', 'Club', 400, 0, 19, 10, { mult: 1, trend: 0.6 }, true],
  ['AURA CLUB MALAGA', 'malaga', 'Dancing', 'Club', 400, 0, 11, 5, { mult: 1, trend: 0.6 }, true],
  ['Riva Club', 'naples', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['Club Partenopeo & Small Eventi', 'naples', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['Duel Club', 'naples', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['HBTOO', 'naples', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['Barfly Disco Restaurant', 'naples', 'Dancing', 'Club', 400, 0, 11, 10, { mult: 1, trend: 0.6 }, true],
  ['Aero Rooftop Bar & Lounge', 'orlando', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['Euphoria Downtown', 'orlando', 'Dancing', 'Club', 400, 0, 11, 10, { mult: 1, trend: 0.6 }, true],
  ['Mango\'s - Orlando', 'orlando', 'Dancing', 'Club', 400, 0, 18, 30, { mult: 1, trend: 0.6 }, true],
  ['Attic Orlando', 'orlando', 'Dancing', 'Club', 400, 0, 10, 5, { mult: 1, trend: 0.6 }, true],
  ['Tier Nightclub', 'orlando', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['Voyeur Nightclub', 'philadelphia', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['Midnight & The Wicked', 'philadelphia', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['Concourse', 'philadelphia', 'Dancing', 'Club', 400, 0, 15, 10, { mult: 1, trend: 0.6 }, true],
  ['Roar Nightclub', 'philadelphia', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['NOTO Philadelphia', 'philadelphia', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['Enclave', 'pittsburgh', 'Dancing', 'Club', 400, 0, 12, 10, { mult: 1, trend: 0.6 }, true],
  ['Cavo Night Club', 'pittsburgh', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['Avalon Social', 'pittsburgh', 'Dancing', 'Club', 400, 0, 12, 10, { mult: 1, trend: 0.6 }, true],
  ['Tilden', 'pittsburgh', 'Dancing', 'Club', 400, 0, 11, 10, { mult: 1, trend: 0.6 }, true],
  ['Howl at the Moon Pittsburgh', 'pittsburgh', 'Dancing', 'Club', 400, 0, 15, 5, { mult: 1, trend: 0.6 }, true],
  ['La Kalle', 'sacramento', 'Dancing', 'Club', 400, 0, 8, 10, { mult: 1, trend: 0.6 }, true],
  ['Social Nightclub', 'sacramento', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['Mango\'s Sacramento', 'sacramento', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['The Press Club', 'sacramento', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['Mix Downtown', 'sacramento', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['NOVA Nightclub', 'sanjose', 'Dancing', 'Club', 400, 0, 10, 10, { mult: 1, trend: 0.6 }, true],
  ['Kaizen Lounge', 'sanjose', 'Dancing', 'Club', 400, 0, 8, 5, { mult: 1, trend: 0.6 }, true],
  ['Miami Beach Club', 'sanjose', 'Dancing', 'Club', 400, 0, 12, 10, { mult: 1, trend: 0.6 }, true],
  ['CLUB CARIBE', 'sanjose', 'Dancing', 'Club', 400, 0, 11, 18, { mult: 1, trend: 0.6 }, true],
  ['The Ritz', 'sanjose', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['Q Nightclub', 'seattle', 'Dancing', 'Club', 400, 0, 12, 10, { mult: 1, trend: 0.6 }, true],
  ['Vue Lounge', 'seattle', 'Dancing', 'Club', 400, 0, 14, 30, { mult: 1, trend: 0.6 }, true],
  ['Trinity', 'seattle', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['Vice Seattle', 'seattle', 'Dancing', 'Club', 400, 0, 11, 10, { mult: 1, trend: 0.6 }, true],
  ['Massive', 'seattle', 'Dancing', 'Club', 400, 0, 12, 10, { mult: 1, trend: 0.6 }, true],
  ['Central the Club', 'split', 'Dancing', 'Club', 400, 0, 17, 10, { mult: 1, trend: 0.6 }, true],
  ['SPACE at Split', 'split', 'Dancing', 'Club', 400, 0, 12, 10, { mult: 1, trend: 0.6 }, true],
  ['Disco Club 305 A.D.', 'split', 'Dancing', 'Club', 400, 0, 16, 10, { mult: 1, trend: 0.6 }, true],
  ['Bar, club', 'split', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['Adriatic Social Club', 'split', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['Proton The Club / Stuttgart', 'stuttgart', 'Dancing', 'Club', 400, 0, 15, 10, { mult: 1, trend: 0.6 }, true],
  ['WONDERS CLUB', 'stuttgart', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['Romantica - Stuttgart', 'stuttgart', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['Boa Disco Stuttgart', 'stuttgart', 'Dancing', 'Club', 400, 0, 15, 10, { mult: 1, trend: 0.6 }, true],
  ['LIV Club & Lounge - Stuttgart', 'stuttgart', 'Dancing', 'Club', 400, 0, 12, 10, { mult: 1, trend: 0.6 }, true],
  ['Club Prana', 'tampa', 'Dancing', 'Club', 400, 0, 15, 10, { mult: 1, trend: 0.6 }, true],
  ['District 8 Night Club', 'tampa', 'Dancing', 'Club', 400, 0, 14, 10, { mult: 1, trend: 0.6 }, true],
  ['Zodiac Nightclub Tampa Bay', 'tampa', 'Dancing', 'Club', 400, 0, 10, 5, { mult: 1, trend: 0.6 }, true],
  ['Tangra Nightclub', 'tampa', 'Dancing', 'Club', 400, 0, 13, 10, { mult: 1, trend: 0.6 }, true],
  ['The Castle', 'tampa', 'Dancing', 'Club', 400, 0, 15, 10, { mult: 1, trend: 0.6 }, true],
];
